var initState = {
	preload: function(){
		...
		this.game.load.spritesheet('slash1', 'as/img/slash1.png', 32, 16);
		this.game.load.spritesheet('slash3', 'as/img/slash3.png', 32, 16);
		this.game.load.spritesheet('slash2', 'as/img/slash2.png', 16, 32);
		this.game.load.spritesheet('slash4', 'as/img/slash4.png', 16, 32);
	},
	create: function() {
